 ...
 */
export function formatKeyboardShortcut(text: string): React.ReactNode[] {
 ...
 * 渲染包含快捷键的文本组件
 */
export function KeyboardShortcutText({ text }: { text: string }) {
  const formatted = formatKeyboardShortcut(text);
  return <>{formatted}</>;
}
